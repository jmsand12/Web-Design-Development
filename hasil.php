...
session_start();
$id = $_SESSION['id_akun'];
$sql= "SELECT * FROM reservasi_wisata JOIN wisata ON reservasi_wisata.id_wisata = wisata.id_wisata WHERE id_akun=$id  ORDER BY transaksi_wisata DESC LIMIT 1";
...
<div class="abrar">
    <div class="abraratas">
        <div class="kiriatas"><p class="tiketabrar"><?php echo $namawisata; ?></p></div>
