...
<html>
    ...
    <!-- Header -->
        ...
        <ul>
                ...
                <li><a href="indexWisata.php">Wisata</a></li>
                <li><a href="indexSpa.php" class="active">Spa</a></li>
    ...
    <h1 class="judul3">Manjakan Diri Anda 💆🏻</h1>
        ...
        <div class="bungkus">
            <div class="satu">
                <a href="login.php"><img class="gambarwisata" src="foto\spa4.png" alt="Foto Spa"></a>
            </div>
            <div class="dua">
                <a href="login.php"><img class="gambarwisata" src="foto\spa3.png" alt="Foto papua"></a>
            </div>
            <div class="tiga">
                <a href="login.php"><img class="gambarwisata" src="foto\spa2.png" alt="Foto magelang"></a>
            </div>
            <div class="tiga">
                <a href="login.php"><img class="gambarwisata" src="foto\spa1.png" alt="Foto lombok"></a>
            </div>
        </div>
        <div>
