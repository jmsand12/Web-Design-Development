...
<html>
    ...
    <!-- Header -->
        <header>
            <ul>
                ...
                <li><a href="destination.php" class="active">Wisata</a></li>
    ...
    <div class="bodysection">
        ...
        <div class="pembungkus">
            <div class="satu">
                <a href="form.php?id_wisata=1"><img class="gambars" src="foto\biji.png" alt="Foto Singa Singapura">
            </div>
            <div class="dua">
                <a href="form.php?id_wisata=2"><img class="gambars" src="foto\jembul.png" alt="Foto Tebing Labuan Bajo">
            </div>
            <div class="tiga">
                <a href="form.php?id_wisata=5"><img class="gambars" src="foto\gas.jpg" alt="Foto Dufan">
            </div>
        </div>
    </div>
