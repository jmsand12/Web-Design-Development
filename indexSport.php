...
<html>
    ...
    <!-- Header -->
        ...
        <ul>
                ...
                <li><a href="indexSport.php" class="active">Sport</a></li>
    ...
    <h1 class="judul1">Penuh Tantangan 🏂</h1>
        ...
        <div class="pembungkus">
            <div class="satu">
                <a href="login.php"><img class="puki" src="foto\sport1.png" alt="Foto bali"></a>
            </div>
            <div class="dua">
                <a href="login.php"><img class="puki" src="foto\sport2.png" alt="Foto singapore"></a>
            </div>
            <div class="tiga">
                <a href="login.php"><img class="puki" src="foto\sport3.png" alt="Foto thailand"></a>
            </div>
        </div>
        <div>
