...
session_start();
$id = $_SESSION['id_akun'];
$sql= "SELECT * FROM reservasi_spa JOIN spa ON reservasi_spa.id_spa = spa.id_spa WHERE id_akun=$id  ORDER BY transaksi_spa DESC LIMIT 1";

$result = mysqli_query($conn, $sql);
   
while ($row = mysqli_fetch_assoc($result)) {
    //var_dump($row);
    $namaspa = $row['nama_spa'];
    $lokasi = $row['alamat'];
...
<div class="abrar">
    <div class="abraratas">
        <div class="kiriatas"><p class="tiketabrar"><?php echo $namaspa; ?></p></div>
