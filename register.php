                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="POST">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example1c" class="form-control form-control-lg py-3" name="nama" autocomplete="off" placeholder="enter your name" style="border-radius:25px ;" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example3c"><i class="bi bi-envelope-at-fill"></i> Nomor Telepon</label>
                        <input type="tel" id="form3Example3c" class="form-control form-control-lg py-3" name="notelp" autocomplete="off" placeholder="enter your phone number" style="border-radius:25px ;" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example3c"><i class="bi bi-envelope-at-fill"></i> Tanggal Lahir</label>
                        <input type="date" id="form3Example3c" class="form-control form-control-lg py-3" name="lahir" autocomplete="off" placeholder="enter your birthdate" style="border-radius:25px ;" />
